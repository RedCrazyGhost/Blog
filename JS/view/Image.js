var ViewImage = {
    ...
    <div class="carousel-inner">
      ...
      <div class="carousel-item">
        <img :src="getCDNUrl('/IMG/2.png')" class="d-block w-100" alt="夜晚的七里滨">
        <div class="carousel-caption d-none d-md-block">
          <h5>夜之滨</h5>
          <p>夜晚的七里滨</p>
        </div>
      ...
      <div class="carousel-item">
        <img :src="getCDNUrl('/IMG/3.png')" class="d-block w-100" alt="清水寺">
        <div class="carousel-caption d-none d-md-block">
          <h5>清水寺</h5>
          <p></p>
        </div>
      ...
      <div class="carousel-item">
        <img :src="getCDNUrl('/IMG/4.png')" class="d-block w-100" alt="京都">
        <div class="carousel-caption d-none d-md-block">
          <h5>京都</h5>
          <p></p>
        </div>
    ...
    methods: {
      getCDNUrl(s) {
        return this.$parent.$parent.getCDNUrl(s)
      },
    }
};