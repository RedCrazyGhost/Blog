var Loading={
    ...
    props: ['isShow'],
    template:`
    <div class="container d-flex align-items-center justify-content-center" v-if="isShow" :style="{height:SetH+'px'}">
        <div>
        <svg class="fa-spin" xmlns="http://www.w3.org/2000/svg" viewBox="-16 0 512 512" width="128px" height="128px">
