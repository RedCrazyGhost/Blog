 ...
 */
/**
 * changer:redcrazyghost
 * changerdate:2021-12-4 
 * 查找修改位置标识符：<-修改->
 * 修改内容：
 * 添加针对 Bootstrap 的文字居中渲染 
 * 添加针对 mermaid 的渲染
 */
...
! function (e, t) {
        ...
        Z = function () {
            ...
            return t.code = function (e, t, u) {
                ...
                /*
                 <-修改-> 
                 添加针对 mermaid 的渲染
                 添加针对 properties 文件的渲染
                 */
                switch (c(n, !0)) {
                    case "properties":
                        let code="";
                        u ? e : c(e, !0).match(/.*=.*/g).forEach(t => {
                            code+="<div>"
                            code+='<span style="color:#f47067">'+t.split('=')[0]+"</span>"
                            code+="="
                            code+="<span>"+t.split('=')[1]+"</span>"
                            code+="</div>"
                        })
                        return '<pre class="' + this.options.langPrefix + c(n, !0) + ' pre-' + app.WebSiteConfig.AppColor + '"><code class="' + this.options.langPrefix + c(n, !0) + '">' + code + "</code></pre>\n"
                    case "mermaid":
                    case "Mermaid":
                        if (app.WebSiteConfig.AppColor === 'dark') {
                            e = "%%{init: {'theme':'dark'}}%%\n" + e;
                        }
                        return '<div class="mermaid">' + (u ? e : c(e, !0)) + '</div>';
                    default:
                        return !this.options.highlight || null != (t = this.options.highlight(e, n)) && t !== e && (u = !0, e = t), e = e.replace(/\n$/, "") + "\n", n ? '<pre class="' + this.options.langPrefix + c(n, !0) + ' pre-' + app.WebSiteConfig.AppColor + '"><code class="' + this.options.langPrefix + c(n, !0) + '">' + (u ? e : c(e, !0)) + "</code></pre>\n" : "<pre><code>" + (u ? e : c(e, !0)) + "</code></pre>\n"
                }
            }, t.blockquote = function (e) {
                // <-修改-> <blockquote> 使用Bootstrap callout
                let strs=""
                e.split("\n").forEach(str=>{strs+="<p>"+str+"</p>"})
                return "<blockquote class=\"callout " + (app.WebSiteConfig.AppColor === "dark" ? "callout-wanring" : "callout-info") + "\">\n" + strs + "</blockquote>\n"
            }, t.html = function (e) {
                return e
                ...
                // <-修改-> 配合bootstrap 的样式 添加表格自动缩进
                return "<div class=\"table-responsive\"><table class=\"table table-hover " + (app.WebSiteConfig.AppColor === "dark" ? "table-dark" : "") + "\">\n<thead>\n" + e + "</thead>\n" + (t = t && "<tbody>" + t + "</tbody>") + "</table></div>\n"
            }, t.tablerow = function (e) {
                return "<tr>\n" + e + "</tr>\n"
            }, t.tablecell = function (e, t) {
                var u = t.header ? "th" : "td";
                // <-修改-> bootstrap 同时使用 align='center' 会失效 使用bootstrap的样式
                return (t.align ? "<" + u + ' class="text-' + t.align + '">' : "<" + u + ">") + e + "</" + u + ">\n"
            }, t.strong = function (e) {
        ...
        j = function () {
            ...
            return e.parse = function (e, t) {
                ...
                for (var u, n, r, i, s, l, a, D, o, c, h, p, f, F, g, A, C = "", d = e.length, k = 0; k < d; k++)
                    if (D = e[k], !(this.options.extensions && this.options.extensions.renderers && this.options.extensions.renderers[D.type]) || !1 === (A = this.options.extensions.renderers[D.type].call({
                            parser: this
    ...
    var P = (L.parse = L).options,
        ...
        G = j.parse,
        m = I.lex;
    r.Lexer = I, r.Parser = j, r.Renderer = Z, r.Slugger = q, r.TextRenderer = O, r.Tokenizer = z, r.getDefaults = e, r.lexer = m, r.marked = L, r.options = P, r.parse = X, r.parseInline = N, r.parser = G, r.setOptions = Q, r.use = U, r.walkTokens = M, Object.defineProperty(r, "__esModule", {
        value: !0
    })
});