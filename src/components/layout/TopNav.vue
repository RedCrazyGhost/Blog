      ...
      <div class="flex items-center justify-between">
        ...
        >
          ...
          >
            ...
            <li class="cursor-pointer" @click="theme.SwitchTheme">
              <font-awesome-icon
            ...
            <li class="md:pl-2">
              <a
                href="https://rsshub.app/github/issue/redcrazyghost/blog"
                class="text-inherit hover:opacity-80 transition-opacity"
              >
                <font-awesome-icon
                  class="iconTheme"
                  icon="fas fa-square-rss"
                  style="color: rgb(234, 119, 55)"
                  size="2x"
                />
              </a>
            </li>
            <li class="md:pl-2">
              <a
                href="mailto:zhan940842903@163.com"
                class="text-inherit hover:opacity-80 transition-opacity"
              >
                <font-awesome-icon
                  class="iconTheme"
