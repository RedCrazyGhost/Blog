...
const workItems: TimelineItem[] = [
  {
    ...
    startDate: "2026-05",
    endDate: "至今",
    description: "2026年05月 - 至今（临港物流业务运营与信息化平台）",
    responsibilities: [
      "参与仓储、运输、调度等环节的物流业务全流程，协同业务团队保障日常运营顺畅",
      "参与物流信息化平台的规划与建设，跟进功能需求梳理、上线落地与业务侧适配",
      "配合平台安全评级、合规审查及等保要求落实，协助推进制度规范与整改闭环",
      "对接内外部协作需求，推动业务流程与系统能力衔接，提升运营协同效率",
    ],
    deliverables: [
      "持续支撑临港物流业务运营与平台化能力建设，配合完成安全合规相关推进工作",
    ],
  },
  {
    title: "上海西井科技股份有限公司 · Golang 开发工程师",
    startDate: "2024-03",
    endDate: "2026-03",
    description:
